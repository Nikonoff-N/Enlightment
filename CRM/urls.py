...
urlpatterns = [
    ...
    path('CRM/exportClients',views.ExportClients,name = "exportClients"),
    ...
    path('CRM/canselLesson/<int:lesson_id>',views.canselLesson, name = 'canselLesson'),
    path('CRM/okLesson/<int:lesson_id>',views.okLesson, name = 'okLesson'),
    ...
    #==================================================================
    path('CRM/salary',views.SalaryView.as_view(),name = 'salary'),
    #===================================================================
    path('CRM/calendar',views.calendar,name = 'calendar')
]